...
public class UserFilterController implements Controller<Node> {
  ...
  private void filterUsers() {
    channelTabController.setUserFilter(chatUserItemTreeItem -> filterUser(chatUserItemTreeItem.getValue()));
    filterApplied.set(
  ...
  private boolean filterUser(CategoryOrChatUserTreeObject treeObject) {
    ChatChannelUser user = treeObject.getUser();

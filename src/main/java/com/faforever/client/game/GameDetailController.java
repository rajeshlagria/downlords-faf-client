...
public class GameDetailController implements Controller<Pane> {
  ...
  public void setGame(Game game) {
    ...
    gameStatusListener = observable -> onGameStatusChanged();
    gameStatusListener.invalidated(game.statusProperty());

    weakGameStatusListener = new WeakInvalidationListener(gameStatusListener);
